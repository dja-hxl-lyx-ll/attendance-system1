        ...
        <el-card class="info-card" shadow="hover">
          ...
          <div class="info-list">
            <div class="info-item">
              ...
              <span class="info-value">{{ userInfo.counselorNo }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
              <span class="info-label">管理班级</span>
              <span class="info-value">{{ userInfo.classCount }} 个班</span>
            </div>
            <div class="info-item">
      ...
      <el-col :span="16">
        ...
        <el-card class="overview-card" shadow="hover" style="margin-top: 20px">
          ...
          <el-row :gutter="20">
            <el-col :span="6">
              <div class="mini-stat">
                <div class="mini-num" style="color: #409eff">6</div>
                <div class="mini-label">管理班级</div>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="mini-stat">
                <div class="mini-num" style="color: #67c23a">300</div>
                <div class="mini-label">学生总数</div>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="mini-stat">
                <div class="mini-num" style="color: #e6a23c">28</div>
                <div class="mini-label">审批通过</div>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="mini-stat">
                <div class="mini-num" style="color: #909399">5</div>
                <div class="mini-label">审批驳回</div>
              </div>
            </el-col>
          </el-row>
